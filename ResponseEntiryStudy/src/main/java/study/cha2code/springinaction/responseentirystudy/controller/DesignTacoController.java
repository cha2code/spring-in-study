...
import study.cha2code.springinaction.responseentirystudy.domain.Ingredient;
...
import study.cha2code.springinaction.responseentirystudy.repository.IngredientRepository;
import study.cha2code.springinaction.responseentirystudy.repository.TacoRepository;
...
public class DesignTacoController {
	...
	public String showDesignForm(Model model, Principal principal) {
		...
		// 현재 user 정보가 담겨 있는 principal의 username을 가져와 저장
		String username = principal.getName();
		// 위에서 가져온 username을 가지고 인증된 사용자를 검색
